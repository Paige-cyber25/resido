...
const MainContent = () => {
  return (
    <div className="bg-white w-full h-full p-5 md:p-28">
      ...
      <div className={`grid mr-auto grid-cols-1 lg:grid-cols-4 mt-20 mb-20 ${styles.gridWrapper}`}>
      ...
      <div className={`mt-28 bg-dark_blue m-auto px-5 ${styles.storyContainer}`}>
        <LazyLoadImage src={storyImage} alt="story" className={`hidden lg:block absolute -top-16 ml-8`} />
        <div className={`text-left ${styles.contentContainer} ml-0 lg:ml-[22rem]`}>
          <h2 className={`text-white font-bold pt-12 text-2xl pb-8 `}>Our Story</h2>
          <p className={`text-white font-light text-base mb-4 md:mb-16 ${styles.storyContent}`}>
      ...
      <div className="flex justify-evenly mt-24">
        <div className="">
          <h2
            className={`text-dark_grey font-semibold text-left mb-20 text-[1.5rem] lg:text-[2.5rem] leading-[1rem]lg:leading-[3rem] ${styles.homeServiceHeader}`}
          >
        ...
        <div>
          <img src={homeServiceIcon} alt="home_service_icon" className={`hidden lg:block`} />
        </div>
      </div>
      <div className={`mt-24`}>
      ...
      <div className={`mt-24 text-center lg:text-right`}>
        ...
        <p
          className={`font-normal text-dark_grey text-center lg:float-right lg:mb-8 ${styles.customerContent}`}
        >
          Send us a quick message and we’ll be where you need us in no time.
        </p>
      </div>
      <form className={`mt-24 lg:ml-[20rem] lg:mb-[20rem] ${styles.inputWrapper}`}>
        <input
          type="text"
          placeholder="Enter your location"
          className={`mb-10 lg:float-right block ml-auto mr-auto lg:ml-[21rem] p-2 lg:p-4 ${styles.input}`}
        />
        <input
          type="text"
          placeholder="Enter your email address"
          className={` lg:float-right block ml-auto mr-auto lg:ml-[20rem]  p-2 lg:p-4 ${styles.input}`}
        />
      </form>
      <div className={` block ml-auto mr-auto lg:float-right w-20 h-12 p-0.5 ${styles.whiteArrowRightWrapper}`}>
        <img
          src={whiteRightArrow}
